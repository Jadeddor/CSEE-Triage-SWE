        ...
        <CardContent className="pt-6">
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 mb-4">
              Your support ticket has been submitted. You should receive an email confirmation shortly.
            </p>
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="text-sm text-gray-700">
                <strong>What happens next?</strong><br />
                • You'll receive an email confirmation with your ticket number<br />
                • Our support team will review your request within 24-48 hours<br />
                • You'll be contacted via email with updates or solutions
              </p>
            </div>
          </div>
        </CardContent>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.category} onValueChange={(value) => handleInputChange('category', value)}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="lab-access">Lab Access</SelectItem>
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <ul className="text-sm text-blue-800 space-y-1">
              <li>• Check if your question is answered in the FAQ section</li>
              <li>• Try the live chat for immediate assistance</li>
              <li>• Include specific error messages or screenshots if applicable</li>
              <li>• Provide your course number or specific context</li>
            </ul>
          </div>
